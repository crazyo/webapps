...
// Created: 9/16/2011 8:40:28 PM

function WebTrends(){
	var that=this;
	// begin: user modifiable
	this.dcsid="dcs6qtdxr25n6qqoh3lyew37e_1l3e";
	this.domain="stats.royalbank.com";
	this.timezone=-5;
	this.fpcdom=".rbcwealthmanagement.com";
	this.onsitedoms="";
	this.downloadtypes="xls,doc,pdf,txt,vsd,csv,zip,mp3,exe,mp4,rss,air,flv,jad,mov,mpeg,avi,wmv,swf";
